...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0a] text-zinc-100 flex flex-col font-sans relative selection:bg-transparent">
      ...
      {/* Navigation Bar - Clean, Without v2.0 badge */}
      <header className="border-b border-white/10 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 text-white text-xs font-medium transition-all active:scale-95"
          >
          ...
          <Link
            to="/login"
            className="bg-white hover:bg-zinc-200 text-zinc-950 px-4 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm flex items-center gap-1.5 active:scale-95"
          >
      ...
      {/* Hero Section */}
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 pt-20 pb-28 space-y-20 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-6 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2">
            ...
            <Link
              to="/dashboard"
              className="border border-white/15 bg-white/5 hover:bg-white/10 text-white px-6 py-3 rounded-xl font-semibold transition-all text-xs flex items-center gap-2 active:scale-95"
            >
        ...
        {/* Feature Cards Grid (In Pure Black, White, and Sleek Gray with Improved Icons) */}
